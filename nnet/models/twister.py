...
from nnet.models.model import checkpoint_artifact_name
from nnet import optimizers
from nnet import envs
from nnet.modules import twister as twister_networks
from nnet.modules.twister.hrvq import SpatialHRVQEncoder, SpatialHRVQTSSM, spatial_cascade_decode, compute_world_model_losses
...
class TWISTER(models.Model):
    ...
    def __init__(self, env_name, override_config={}, name="ECHELON: Spatial HRVQ World Model"):
        ...
        self.config.hrvq_num_positions = 16
        self.config.hrvq_position_dim = 8 * model_params.dim_cnn  # = 256
        self.config.hrvq_spatial_proj_dim = 128
        ...
        for key, value in override_config.items():
            ...
            if key=="precision":
                self.config[key] = {"float16": torch.float16, "bfloat16": torch.bfloat16, "float32": torch.float32}[value]
            else:
        ...
        self.encoder_network = SpatialHRVQEncoder(
            ...
            num_positions=self.config.hrvq_num_positions,
