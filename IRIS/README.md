> **ECHELON fork.** This is a fork of IRIS, adapted to host ECHELON's 3-level
> spatial HRVQ tokenizer for a cross-architecture codebook-transfer experiment.
> GPU launch assets live in `launch_package/`. The original IRIS documentation
> follows.
